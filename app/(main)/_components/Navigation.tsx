...
import React, { ElementRef, MouseEvent, useRef, useState } from 'react';
    ...
    <>
      <aside
        ...
        className={cn(
          ...
          isResetting && 'transion-all ease-in-out duration-300',
          isMobile && 'w-0'
        )}
      >
        <div
        ...
        hover:dark:bg-neutral-600 absolute top-3 right-2 opacity-0 group-hover/sidebar:opacity-100 transition`,
      ...
      <div
        ref={navbarRef}
        className={cn(
          'absolute top-0 z-[99999px] left-60 w-[calc(100%-240px)]',
